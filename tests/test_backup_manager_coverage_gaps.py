...
class TestVerifyBackupErrors:
    ...
    def test_verify_empty_backup_file(self, tmp_path):
        ...
        with mock.patch('sqlite3.connect', side_effect=sqlite3.DatabaseError("not a database")):
    ...
    def test_verify_backup_permission_denied(self, tmp_path):
        ...
        if backup_result['success']:
            ...
            with mock.patch('sqlite3.connect', side_effect=PermissionError("Permission denied")):
