...
def weighted_ensemble_decision(payload: dict, reliability_scores: dict):
    """
        ...
        vote_debug.append(
            {
                ...
                "action": Config.ACTION_LABELS[Config.LANG][action],
    ...
    return {
        "action": Config.ACTION_LABELS[Config.LANG][final_action],
