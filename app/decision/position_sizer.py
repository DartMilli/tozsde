...
class PositionSizer:
    ...
    def __init__(self, max_position_pct: float = None):
        self.max_position_pct = (
            ...
            else Config.P6_POSITION_MAX_PCT
        )
    ...
    def compute(
        ...
        confidence_factor = max(Config.P6_MIN_CONF_FACTOR, min(1.0, confidence))
        wf_factor = max(Config.P6_MIN_WF_FACTOR, min(1.0, wf_score))
...
def apply_position_sizing(
    ...
    safety_discount = Config.P6_SAFETY_DISCOUNT if safety_override else 0.0
