...
class BackupManager:
        ...
        try:
            ...
            try:
                ...
                if not verification['valid']:
                    logger.warning(f"Backup verification failed: {verification['error']}")
                    return {
                        'success': False,
    ...
    def cleanup_old_backups(self) -> Dict:
        ...
        """
        logger.info(f"Starting backup cleanup (retention: {self.BACKUP_RETENTION_DAYS} days)...")
        ...
        try:
            ...
            logger.info(f"Backup cleanup complete: {len(deleted_files)} files deleted, "
    ...
    def get_backup_stats(self) -> Dict:
        ...
        try:
            ...
            backup_files_with_mtime = [
                (f, f.stat().st_mtime) for f in backup_files
            ]
    ...
    def restore_backup(self, backup_path: Path, target_path: Optional[Path] = None) -> Dict:
        """
...
def main():
    ...
    if args.backup:
        ...
        print(f"  Oldest backup: {stats['oldest_backup']} ({stats['oldest_age_days']} days old)")
